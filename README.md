...
### Installation:
Copy the *.UA2 file at the root of the SD card. 
Copy [spectrum.dat](https://github.com/sorgelig/ZX_Spectrum-128K_MIST/tree/master/releases) file to the root of SD card.
